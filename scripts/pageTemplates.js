...
function program5(depth0,data) {
  ...
  stack1 = helpers.each.call(depth0, depth0.repos, {hash:{},inverse:self.noop,fn:self.program(3, program3, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\r\n    </tbody>\r\n  </table>\r\n";
  stack1 = helpers['if'].call(depth0, depth0.isPhone, {hash:{},inverse:self.noop,fn:self.program(5, program5, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
...
templates['repoCategory'] = template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
...
function program3(depth0,data) {
  ...
  stack1 = helpers['if'].call(depth0, depth0.isPhone, {hash:{},inverse:self.noop,fn:self.program(3, program3, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  return buffer;
  });
return templates;
